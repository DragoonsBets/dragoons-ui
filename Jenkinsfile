    ...
    stage('Build Release') {
      ...
      steps {
        container('nodejs') {
          ...
          // Create a release
          sh "./node_modules/@sentry/cli/sentry-cli releases new \$(./node_modules/@sentry/cli/sentry-cli releases propose-version) --project dragoons-ui -o dragoons --log-level debug"
